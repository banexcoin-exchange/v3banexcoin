				...
				bindEvents: function(el) {
					...
					.closest('.'+this._name+'-container').find('input').each(function(){
						...
						$(this).on('keydown', function(e) {
							...
							if ( e.which !== 96 && e.which !== 97 && e.which !== 98 && e.which !== 99 && e.which !== 100 & e.which !== 101 && e.which !== 102 && e.which !== 103 && e.which !== 104 && e.which !== 105 && /* antes agregamos las nuestras*/ e.which !== 39 && e.which !== 37 && e.which !== 9 && e.which !== 8 && e.which !== 46 && !pattern.test(String.fromCharCode(e.which))) {
								e.preventDefault();
								return false;
							}
				...
				wrapInputElement: function(el) {
					...
					el.addClass(this._name+'-input') // Add a class to the input with the plugin name
					  ...
					  .closest('.'+this._name+'-container').prepend(elIconContainer) // Add a flag icon before the input inside of the container
					  									   ...
					  									   //.css('min-width', this.$element.outerWidth() + 'px'); se comenta por pruebas
					  									   .css('min-width', '100%');
